...
exports.sendContactConfirmationToUser = void 0;
const mail_1 = require("./mail");
const sendContactConfirmationToUser = async (userEmail, userName) => {
    const html = `
...
exports.sendContactConfirmationToUser = sendContactConfirmationToUser;
